...
import org.openapitools.model.InheritanceSample;
...
@Validated
@Api(value = "sampleB", description = "the sampleB API")
public interface SampleBApi {

    default Optional<NativeWebRequest> getRequest() {
        return Optional.empty();
    }

    @ApiOperation(value = "", nickname = "sampleBGet", notes = "", response = InheritanceSample.class, tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "OK", response = InheritanceSample.class) })
    @RequestMapping(value = "/sampleB",
    ...
    @ApiOperation(value = "", nickname = "sampleBPost", notes = "", tags={  })
    @ApiResponses(value = { 
